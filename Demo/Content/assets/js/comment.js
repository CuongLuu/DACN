const renderComment = (data) => `
          <div class="comment">
            <div class="wrapper">
              <img src=${data.NguoiDung.anh} alt="" width="24" height="24" style="margin-top: 4px">
              <div class="w-100">
                <div class="comment-body">
                  <div class="username">${data.NguoiDung.tenND}</div>
                  <div class="content">${data.content}</div>
                </div>
              <button data-comment-id="${data.maCMT}" class="reply btn">
          ...
          <div class="wrapper-sub-comment">
            <div class="sub-comment-list" data-comment-id="${data.maCMT}">
            </div>
            <div class="sub-comment-form hide" data-comment-id="${data.maCMT}">
              <textarea class="content-sub-comment" name="subComent" rows="1" placeholder="Bình luận..." data-comment-id="${data.maCMT}"></textarea>
              <button id="add-sub-comment" data-comment-id="${data.maCMT}" class="btn btn-primary">Gửi</button>
            </div>
          </div>
        `
const renderSubComment = (data) => `
            <div class="sub-comment" data-comment-id="${data.maCMT}">
              <img src=${data.NguoiDung.anh} alt="sub-comment" width="24" height="24" style="margin-top: 4px">
